(function ($) {
  ...
  $(".banner-slider2").slick({
    ...
    slidesToShow: 1,
    arrows: true,
    prevArrow: '<i className="left-arrow las la-arrow-left"></i>',
    nextArrow: '<i className="right-arrow las la-arrow-right"></i>',
    dots: false,
    speed: 500,
    infinite: true,
    cssEase: "ease-in-out",
  ...
  $(".category-slick").slick({
    ...
    slidesToShow: 6,
    arrows: false,
    prevArrow: '<i className="prev las la-arrow-left"></i>',
    nextArrow: '<i className="next las la-arrow-right"></i>',
    dots: false,
    speed: 500,
    infinite: true,
    cssEase: "ease-in-out",
  ...
  $(".feature-slider-active").slick({
    ...
    autoplay: true,
    arrows: false,
    prevArrow: '<i className="prev fas fa-angle-left"></i>',
    nextArrow: '<i className="next fas fa-angle-right"></i>',
    loop: true,
    infinite: true,
    dots: false,
    responsive: [
