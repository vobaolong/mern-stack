    ...
    return this.each(function () {
      ...
      if (
        ("right" == f.position || "left" == f.position
          ? nav.prepend(
              '<a href="#" className="menu-toggle"><span className="bars"><span></span><span></span><span></span></span> ' +
                menuLabel +
                "</a>"
            )
          : nav.prepend(
      ...
      "right" == f.position && nav.addClass("right"),
        ...
        f.closeBtn &&
          ...
          nav
            .find("ul:first")
            .append(
              '<li><a href="#" className="close-menu"><span className="icon-close"></span> ' +
                closeLabel +
                "</a></li>"
            ),
        ...
        nav.find("li a").each(function () {
          0 < u(this).next().length &&
            u(this)
              ...
              .addClass("has-sub")
              .append(
                '<a className="dd-toggle" href="#"><span className="icon-plus"></span></a>'
              );
        }),
